...
```{r}
model_df <- cbind.data.frame(df1,rain_composite) %>%
  mutate(rain_lag1 = lag(rain_composite,1),
         rain_lag2 = lag(rain_composite,2),
         rain_lag3 = lag(rain_composite,3),
         rain_lag4 = lag(rain_composite,4),
         rain_lag5 = lag(rain_composite,5),
         rain_lag6 = lag(rain_composite,6),
         rain_lag7 = lag(rain_composite,7),
         rain_lag8 = lag(rain_composite,8),
         rain_lag9 = lag(rain_composite,9),
         rain_lag10 = lag(rain_composite,10),
         rain_lag11 = lag(rain_composite,11),
         rain_lag12 = lag(rain_composite,12),
         rain_lag13 = lag(rain_composite,13),
         rain_lag14 = lag(rain_composite,14)
         )
mod1 <- glm(N_exposures ~ rain_composite + rain_lag1 + rain_lag2 + rain_lag3 + rain_lag4 + rain_lag5 + rain_lag6 + rain_lag7 + rain_lag8 + rain_lag9 + rain_lag10 +rain_lag11 + rain_lag12 + rain_lag13 + rain_lag14, data=model_df, family='poisson')
summary(mod1)

coefs_rain <- coef(mod1)[-1] 
plot(coef(mod1)[-1])
